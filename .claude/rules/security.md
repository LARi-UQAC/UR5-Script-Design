...
3. Do not expose detailed threat models in frontend docs; keep generic descriptions in `web/SimulCuve.Web/docs/`
...
- Undocumented security constraints in code (always add an explanatory comment and reference this file or `web/SimulCuve.Web/docs/`)
